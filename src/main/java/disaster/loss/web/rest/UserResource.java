...
import disaster.loss.service.MailService;
...
import disaster.loss.web.rest.errors.EmailAlreadyUsedException;
import disaster.loss.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
