...
/**
 * REST controller for managing {@link disaster.loss.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    public ResponseEntity<Department> createDepartment(@RequestBody Department department) throws URISyntaxException {
        ...
        return ResponseEntity
            ...
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getDepartmentId()))
            .body(result);
    }
    ...
    public ResponseEntity<Department> updateDepartment(
        @PathVariable(value = "departmentId", required = false) final String departmentId,
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, department.getDepartmentId()))
            .body(result);
    }
    ...
    public ResponseEntity<Department> partialUpdateDepartment(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, department.getDepartmentId())
        );
    }
