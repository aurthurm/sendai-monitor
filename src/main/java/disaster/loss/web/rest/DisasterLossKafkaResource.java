...
@RestController
@RequestMapping("/api/disaster-loss-kafka")
public class DisasterLossKafkaResource {

//    private final Logger log = LoggerFactory.getLogger(DisasterLossKafkaResource.class);
...
//    public DisasterLossKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
//        this.output = output;
//    }
