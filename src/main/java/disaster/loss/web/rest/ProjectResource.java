...
/**
 * REST controller for managing {@link disaster.loss.domain.Project}.
 */
@RestController
@RequestMapping("/api")
public class ProjectResource {
    ...
    public ResponseEntity<Project> createProject(@RequestBody Project project) throws URISyntaxException {
        ...
        return ResponseEntity
            ...
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getProjectId()))
            .body(result);
    }
    ...
    public ResponseEntity<Project> updateProject(
        @PathVariable(value = "projectId", required = false) final String projectId,
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, project.getProjectId()))
            .body(result);
    }
    ...
    public ResponseEntity<Project> partialUpdateProject(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, project.getProjectId())
        );
    }
