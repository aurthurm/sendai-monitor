...
public interface SendaiMonitorAggregateTartgetBRepository extends JpaRepository<HumanPopulation, Integer> {
	...
	@Query(value = "SELECT 'name' AS name, SUM(c.value) AS totalCount,\n"
			...
			+ "('113b3ae1-a5b8-11ec-adfd-90ccdfa85f11', '1edabdc2-a5b8-11ec-adfd-90ccdfa85f11', "
			+ "'186894a2-a5b8-11ec-adfd-90ccdfa85f11', '0850d6f2-a5b8-11ec-adfd-90ccdfa85f11', 'f026ee93-a5b7-11ec-adfd-90ccdfa85f11')", nativeQuery = true)
	...
	@Query(value = "SELECT 'name' AS name, SUM(c.value) AS totalCount,\n"
			...
			+ "FROM public.human_population AS c \n" + "where human_population_disaster_category_id in "
			+ "('0850d6f2-a5b8-11ec-adfd-90ccdfa85f11')", nativeQuery = true)
