...
export class LiveStockComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.liveStockService
      ...
      .subscribe({
        next: (res: HttpResponse<ILiveStock[]>) => {
  ...
  delete(liveStock: ILiveStock): void {
    const modalRef = this.modalService.open(LiveStockDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ILiveStock[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/live-stock'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
