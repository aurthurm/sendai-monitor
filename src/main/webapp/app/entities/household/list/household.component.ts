...
export class HouseholdComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.householdService
      ...
      .subscribe({
        next: (res: HttpResponse<IHousehold[]>) => {
  ...
  trackInfractructureId(index: number, item: IHousehold): string {
  ...
  protected onSuccess(data: IHousehold[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
