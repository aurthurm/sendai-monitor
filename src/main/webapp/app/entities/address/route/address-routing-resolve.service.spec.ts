...
describe('Address routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IAddress returned by find', () => {
      // GIVEN
      service.find = jest.fn(addressId => of(new HttpResponse({ body: { addressId } })));
      mockActivatedRouteSnapshot.params = { addressId: 'ABC' };
      ...
      expect(resultAddress).toEqual({ addressId: 'ABC' });
    });
