...
describe('Department routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IDepartment returned by find', () => {
      // GIVEN
      service.find = jest.fn(departmentId => of(new HttpResponse({ body: { departmentId } })));
      mockActivatedRouteSnapshot.params = { departmentId: 'ABC' };
      ...
      expect(resultDepartment).toEqual({ departmentId: 'ABC' });
    });
