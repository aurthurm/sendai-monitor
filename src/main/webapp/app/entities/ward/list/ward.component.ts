...
export class WardComponent implements OnInit {
  ...
  trackWardId(index: number, item: IWard): string {
    return item.wardId!;
  }
  ...
  protected onSuccess(data: IWard[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
