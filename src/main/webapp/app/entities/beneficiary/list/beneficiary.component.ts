...
export class BeneficiaryComponent implements OnInit {
  ...
  trackBeneficiaryId(index: number, item: IBeneficiary): string {
  ...
  protected sort(): string[] {
    ...
    if (this.predicate !== 'beneficiaryId') {
      result.push('beneficiaryId');
    }
    return result;
  }
  ...
  protected onSuccess(data: IBeneficiary[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
