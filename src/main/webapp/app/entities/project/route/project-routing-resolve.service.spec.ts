...
describe('Project routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IProject returned by find', () => {
      // GIVEN
      service.find = jest.fn(projectId => of(new HttpResponse({ body: { projectId } })));
      mockActivatedRouteSnapshot.params = { projectId: 'ABC' };
      ...
      expect(resultProject).toEqual({ projectId: 'ABC' });
    });
