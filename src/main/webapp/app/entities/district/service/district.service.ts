...
export class DistrictService {
  ...
  update(district: IDistrict): Observable<EntityResponseType> {
    return this.http.put<IDistrict>(`${this.resourceUrl}/${getDistrictIdentifier(district) as string}`, district, { observe: 'response' });
  }

  partialUpdate(district: IDistrict): Observable<EntityResponseType> {
    return this.http.patch<IDistrict>(`${this.resourceUrl}/${getDistrictIdentifier(district) as string}`, district, {
      observe: 'response',
    });
  }
