...
describe('District routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IDistrict returned by find', () => {
      // GIVEN
      service.find = jest.fn(districtId => of(new HttpResponse({ body: { districtId } })));
      mockActivatedRouteSnapshot.params = { districtId: 'ABC' };
      ...
      expect(resultDistrict).toEqual({ districtId: 'ABC' });
    });
