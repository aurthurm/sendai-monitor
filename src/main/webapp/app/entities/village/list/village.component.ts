...
export class VillageComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.villageService
      ...
      .subscribe({
        next: (res: HttpResponse<IVillage[]>) => {
  ...
  trackVillageId(index: number, item: IVillage): string {
  ...
  protected sort(): string[] {
    ...
    if (this.predicate !== 'villageId') {
      result.push('villageId');
    }
    return result;
  }
  ...
  protected onSuccess(data: IVillage[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
