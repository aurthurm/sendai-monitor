...
describe('Village routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IVillage returned by find', () => {
      // GIVEN
      service.find = jest.fn(villageId => of(new HttpResponse({ body: { villageId } })));
      mockActivatedRouteSnapshot.params = { villageId: 'ABC' };
      ...
      expect(resultVillage).toEqual({ villageId: 'ABC' });
    });
