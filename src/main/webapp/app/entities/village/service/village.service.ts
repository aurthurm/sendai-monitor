...
export class VillageService {
  ...
  update(village: IVillage): Observable<EntityResponseType> {
    return this.http.put<IVillage>(`${this.resourceUrl}/${getVillageIdentifier(village) as string}`, village, { observe: 'response' });
  }

  partialUpdate(village: IVillage): Observable<EntityResponseType> {
    return this.http.patch<IVillage>(`${this.resourceUrl}/${getVillageIdentifier(village) as string}`, village, { observe: 'response' });
  }
