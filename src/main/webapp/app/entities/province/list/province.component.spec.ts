...
describe('Province Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'province', component: ProvinceComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.provinces?.[0]).toEqual(expect.objectContaining({ countryId: 'ABC' }));
  });
