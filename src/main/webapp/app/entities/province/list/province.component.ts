...
export class ProvinceComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.provinceService
      ...
      .subscribe({
        next: (res: HttpResponse<IProvince[]>) => {
  ...
  trackCountryId(index: number, item: IProvince): string {
  ...
  protected onSuccess(data: IProvince[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
