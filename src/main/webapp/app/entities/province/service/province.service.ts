...
export class ProvinceService {
  ...
  update(province: IProvince): Observable<EntityResponseType> {
    return this.http.put<IProvince>(`${this.resourceUrl}/${getProvinceIdentifier(province) as string}`, province, { observe: 'response' });
  }

  partialUpdate(province: IProvince): Observable<EntityResponseType> {
    return this.http.patch<IProvince>(`${this.resourceUrl}/${getProvinceIdentifier(province) as string}`, province, {
      observe: 'response',
    });
  }
